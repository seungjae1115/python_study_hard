...
네 자리 숫자를 입력하세요 >>> 2025
맨 마지막 숫자는 5입니다.
맨 마지막 숫자는 5이며, 홀수입니다.       -> 조건문 써야하고, 홀짝 구분하려면 연산 필요합니다.
'''
...
# last_num과 even_odd라는 변수들을 선언해서 활용한 사례
# last_num = int(num[3])
# if last_num % 2 == 0:
#     even_odd = "짝수"
# else:
...
짝수로 끝나면 '운행 가능, 아니면 '운행불가'가 출력되는 프로그램을 작성하시오.
단, 차량 번호는 '237가1234'와 같은 형식으로 입력 받는다고 가정합시다.
'''
# car_num = input("차량 번호를 입력하세요 >>> ")
# last_num = int(car_num[-1])
# if last_num % 2 ==0:
#     print(f"차량번호 {car_num}은 오늘 운행 가능입니다.")
# else:
#     print(f"차량번호 {car_num}은 오늘 운행 불가입니다.")
